...
exports.sendEmailForgotPassword = exports.sendOTPMail = void 0;
const common_1 = require("../../config/common");
const Sib = require('sib-api-v3-sdk');
const currentYear = 2024;
//const sendEmailWeb = (key, senderEmail, appName, recipientEmail, clientLink) => {
const sendOTPMail = (recipientEmail, name, otp) => {
    const client = Sib.ApiClient.instance;
    const apiKey = client.authentications['api-key'];
    apiKey.apiKey = common_1.COMMON_CONFIG.SECURITY_KEY.MAIL_KEY;
    const tranEmailApi = new Sib.TransactionalEmailsApi();
    const sender = {
        email: common_1.COMMON_CONFIG.NETWORK_CONFIG.MAIL_SENDER,
        name: "Tokpay",
    };
    const receivers = [
        {
...
const sendEmailForgotPassword = (recipientEmail, user, otp) => {
    const client = Sib.ApiClient.instance;
    const apiKey = client.authentications['api-key'];
    apiKey.apiKey = common_1.COMMON_CONFIG.SECURITY_KEY.MAIL_KEY;
    const tranEmailApi = new Sib.TransactionalEmailsApi();
...
module.exports = { sendOTPMail: exports.sendOTPMail, sendEmailForgotPassword: exports.sendEmailForgotPassword };
